...
sql50 = """ALTER TABLE docent ADD COLUMN city VARCHAR(200)"""
...
sql8 = """ CREATE TABLE IF NOT EXISTS matter_date(
 ...
 ON DELETE CASCADE ON UPDATE NO ACTION)"""
sql9 = """ CREATE TABLE IF NOT EXISTS matter_hour(
 id_Matter integer,
 id_Hour integer,
 ...
 ON DELETE CASCADE ON UPDATE NO ACTION)"""
sql10 = """ CREATE TABLE IF NOT EXISTS date_hour(
 id_Date integer,
 id_Hour integer,
 ...
 FOREIGN KEY (id_Hour) REFERENCES hour (id_Hour) 
 ON DELETE CASCADE ON UPDATE NO ACTION)"""
sql11 = """ CREATE TABLE IF NOT EXISTS docent_matter(
 id_Docent integer,
 id_Matter integer,
 ...
 FOREIGN KEY (id_Matter) REFERENCES matter (id_Matter) 
 ON DELETE CASCADE ON UPDATE NO ACTION)"""
sql12 = """ CREATE TABLE IF NOT EXISTS docent_city(
 id_Docent integer,
 id_city integer,
